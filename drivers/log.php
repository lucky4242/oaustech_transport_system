...
<body class="bg-dark" style="background-image: linear-gradient(gray, #2144)">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Drivers Login Page </div>
      <div class="card-body">
        <form method="POST" action="../drivers/login.php">
          ...
          <button type="submit" class="btn btn-primary btn-block" name="login" style="background-image: linear-gradient(gray, #2144)">
            Login
          </button>
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="../drivers/reg.php">
            Signup
          </a>
          <!-- <a class="d-block small" href="forgot-password.php"
              >Forgot Password?</a -->
          <!-- > -->
        </div>
      </div>
