...
<body class="bg-dark" style="background-image: linear-gradient(gray, #2144)">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Student Registration Page</div>
      <div class="card-body">
        <form method="POST" action="../students/register.php" enctype="multipart/form-data">
          ...
          <div>
            <div class="form-group">
              <div class="form-label-group">
                <input type="number" id="mat_num" class="form-control" placeholder="Matriculation Number" name="mat_num" required="required" />
                <label for="inputEmail">Matric_Number</label>
              </div>
            </div>
            <div class="form-group">
              <div class="form-label-group">
            ...
            <button type="submit" class="btn btn-primary btn-block" name="submit" style="background-image: linear-gradient(gray, #2144)">
              Submit
            </button>
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="../students/log.php">Sign in</a>
